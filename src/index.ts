...
var randomAccount =  '0xea3d67ECd778a59de4cCD5792E43F4501dE07215';
...
gateway.contract.events.RemoteExec(function (error, event){
    ...
    if (error == null) {
        ...
        executeLambdaFunction(functionRemoteResource, functionParameters).then((response) => {
            ...
            gateway.contract.methods.execRemoteResponse(jsonResponse).send({from: randomAccount}).catch(console.error);
        }).catch(console.error)
    } else {
